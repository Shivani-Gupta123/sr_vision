...
if(document.getElementsByClassName("activeMenu").length == 0){
	navActiveItem[5].classList.add("activeMenu");
}
...
//modifying jobs carousel in mobile view
if (window.innerWidth < 575) {
    var elem = document.getElementsByClassName('careerJobs');
    var elemL = elem.length;
    var fragment = document.createDocumentFragment();
    for (var i = 0; i < elemL; i++) {
        while (elem[0].firstChild) {
            fragment.appendChild(elem[0].firstChild);
        }
        elem[0].parentNode.replaceChild(fragment, elem[0]);
    }

    var flexJobs = document.getElementsByClassName("flexJobs");
    var lengthJ = flexJobs.length;
    for (var i = 0; i < lengthJ; i++) {
        flexJobs[0].classList.remove("flexJobs");
    }

    var innerCareer = document.getElementsByClassName("innerCareer");
    var innerL = innerCareer.length;
    for (var i = 0; i < innerCareer.length; i++) {
        innerCareer[i].classList.add("carItem");
    }
    for (var i = 0; i < innerL; i++) {
        innerCareer[0].classList.remove("innerCareer");
    }
    var jobCarouselFolds = document.querySelectorAll(".sTwitter .carItem");
    var sTwitter = document.querySelectorAll(".sTwitter");
    var nIndicators = document.querySelectorAll(".nIndicators li");
    if (jobCarouselFolds.length == 1) {
        nIndicators[0].classList.add("noDisplay");
        for (var m = 0; m < sTwitter.length; m++) {
            sTwitter[m].children[0].classList.add("careerCaro");
            sTwitter[m].children[0].classList.remove("carItem");
            sTwitter[m].children[0].classList.remove("active");
            sTwitter[m].parentElement.classList.remove("carouselDiv");
        }
    }
    else if (jobCarouselFolds.length > 1){
        (document.querySelectorAll(".jobs-carousel .carItem"))[0].classList.add("active");
    }
} else {
    //handling dots as per caritems in jobs carousel
    var jobCarouselFolds = document.querySelectorAll(".sTwitter .carItem");
    var sTwitter = document.querySelectorAll(".sTwitter");
    var nIndicators = document.querySelectorAll(".nIndicators li");

    for (var i = 0; i < nIndicators.length; i++) {
        nIndicators[i].classList.add("noDisplay");
    }
    for (var i = 0; i < jobCarouselFolds.length; i++) {
        nIndicators[i].classList.remove("noDisplay");
    }
    if (jobCarouselFolds.length == 1) {
        nIndicators[0].classList.add("noDisplay");
        for (var m = 0; m < sTwitter.length; m++) {
...
if (ymlSalt.length != 0) {
    for (var i = 1; i < ymlSalt.length; i++) {
