...
var loadMoreBtn = document.getElementsByClassName("buttonMore")[0];
if (loadMoreBtn) {
    loadMoreBtn.addEventListener("click", function () {
        var elemThis1 = this;
        if (elemThis1.parentElement.parentElement.children[2].children[0].children[0].innerHTML == "View Less") {
            elemThis1.parentElement.parentElement.children[1].style.display = "none";
            elemThis1.parentElement.parentElement.children[2].children[0].children[0].innerHTML = "View More";
            elemThis1.parentElement.parentElement.scrollIntoView();
        } else {
            elemThis1.parentElement.parentElement.children[1].style.display = "block";
            elemThis1.parentElement.parentElement.children[2].children[0].children[0].innerHTML = "View Less";
        }
    });
}
if (window.innerWidth < 991) {
...
if (window.innerWidth > 992) {
    var arrowSection = document.getElementsByClassName("arrowSection")[0];
    arrowSection.style.bottom = "13rem";
}

var tagItemsSalt = document.querySelectorAll(".tagItems");
for (var i = 0; i < tagItemsSalt.length; i++) {
    tagItemsSalt[i].addEventListener("click", function (event) {
