...
var loadMoreBtn = document.getElementsByClassName("loadMoreBtn");
var viewMoreHide = document.getElementsByClassName("viewMoreHide");
var btnText = document.querySelectorAll(".loadMoreBtn > span")[0];
var upperContainer = document.querySelectorAll(".nImg")[0];
var toggleFlag = true;
var mainSlider = document.querySelectorAll(".mainSliderElem");
var modalOpen = true;
var flagPhone = false;
var flagCopyVertical = false;

if (window.innerWidth > 576 && window.innerWidth < 767) {
  var locateCompany = document.getElementById("searchVerticals");
  if (locateCompany) {
    locateCompany.addEventListener("click", function () {
      window.scrollTo(0, 0);
      document.body.scrollTop = 0;
    });
  }
}
if (mainSlider[0].offsetTop === 0) {
  modalOpen = false;
} else {
  modalOpen = true;
}
for (var i = 0; i < loadMoreBtn.length; i++) {
  loadMoreBtn[i].addEventListener("click", function (event) {
    loadContent(event);
  });
}

// this for loading more cards with animation on click of load more button
function loadContent(event) {
  if (toggleFlag) {
    viewMoreHide[0].style.display = "block";
    event.currentTarget.children[0].style.display = "none";
    event.currentTarget.children[1].style.display = "block";
    var moduleS = event.currentTarget.parentElement.previousElementSibling.getElementsByClassName("module");
    var lineS = event.currentTarget.parentElement.previousElementSibling.getElementsByClassName("borderAnimCards");
    for (var i = 0; i < moduleS.length; i++) {
      moduleS[i].classList.remove("come-in", "already-visible");
      lineS[i].classList.remove("comeInBorder", "already-visible");
    }
    for (var i = 0; i < moduleS.length; i++) {
      if (animateCard(true, moduleS[i])) {
        moduleS[i].classList.add("come-in");
        lineS[i].classList.add("comeInBorder");
      }
    }
    modalOpen = true;
    toggleFlag = false;
    ...
    toggleFlag = true;
    viewMoreHide[0].style.display = "none";
    event.currentTarget.children[0].style.display = "block";
    event.currentTarget.children[1].style.display = "none";
    upperContainer.scrollIntoView();
    modalOpen = true;
  }
}
var verSearchIp = document.getElementById("searchVerticals");
var locateBrands = document.getElementsByClassName("locateBrands")[0];
if (verSearchIp) {
  verSearchIp.addEventListener("click", function (event) {
    locateBrands.scrollIntoView(); //setting the focus when the user clicks on load less button
  });
}
var isSafariV = navigator.userAgent.match(/iPhone|iPad|iPod/i);
var copyDiv = document.querySelectorAll(".copyDiv");
var phoneDiv = document.querySelectorAll(".phoneDivVertical");
var copyClicked = false;
var copyLinkTooltip = document.querySelectorAll(".copyLinkTooltip");
var hiddenTxt = document.querySelectorAll(".hiddenTxt");
var blackIcon = false;
var whiteIcon = false;

// this for copy functionality
for (var i = 0; i < copyDiv.length; i++) {
  for (var j = 0; j < copyLinkTooltip.length; j++) {
    hiddenTxt[j].style.display = "none";
  }
  copyDiv[i].addEventListener("click", function () {
    flagCopyVertical = true;
    var el = this;
    for (var j = 0; j < copyLinkTooltip.length; j++) {
      if (isSafariV) {
        if (el.children[3] !== hiddenTxt[j]) {
          hiddenTxt[j].readOnly = false;
          hiddenTxt[j].classList.add("hiddenTxt");
          hiddenTxt[j].classList.remove("txtareaSafari");
          hiddenTxt[j].style.display = "none";
        }
      }
      if (!copyLinkTooltip[j].parentElement.children[0].classList.contains("noDisplay")) {
        copyLinkTooltip[j].parentElement.children[0].classList.add("copyIcon");
        copyLinkTooltip[j].parentElement.children[0].classList.remove("copyIconActive");
      } else if (!copyLinkTooltip[j].parentElement.children[1].classList.contains("noDisplay")) {
        copyLinkTooltip[j].parentElement.children[1].classList.add("copyIconWhite");
        copyLinkTooltip[j].parentElement.children[1].classList.remove("copyIconActive");
      }
    }

    if (isSafariV) {
      if (el.children[3].classList.contains("hiddenTxt")) {
        el.children[3].readOnly = false;
        el.children[3].classList.remove("hiddenTxt");
        el.children[3].classList.add("txtareaSafari");
        el.children[3].style.display = "block";
        el.children[3].focus();
        el.children[3].setSelectionRange(0, 9999);
        el.children[3].readOnly = true;
        if (!el.children[0].classList.contains("noDisplay")) {
          el.children[0].classList.remove("copyIcon");
          el.children[0].classList.add("copyIconActive");
          blackIcon = true;
        } else if (!el.children[1].classList.contains("noDisplay")) {
          el.children[1].classList.remove("copyIconWhite");
          el.children[1].classList.add("copyIconActive");
          whiteIcon = true;
        }
      } else {
        el.children[3].readOnly = false;
        el.children[3].classList.add("hiddenTxt");
        el.children[3].classList.remove("txtareaSafari");
        el.children[3].style.display = "none";
        if (blackIcon) {
          el.children[0].classList.add("copyIcon");
          el.children[0].classList.remove("copyIconActive");
        } else if (whiteIcon) {
          el.children[1].classList.add("copyIconWhite");
          el.children[1].classList.remove("copyIconActive");
        }
      }
    } else {
      el.children[3].readOnly = true;
      el.children[3].style.display = "block";
      el.children[3].select();
      document.execCommand("copy");
      setTimeout(function () {
        if (el.children[0].classList.contains("copyIconActive")) {
          el.children[0].classList.add("copyIcon");
          el.children[0].classList.remove("copyIconActive");
        } else if (el.children[1].classList.contains("copyIconActive")) {
          el.children[1].classList.add("copyIconWhite");
          el.children[1].classList.remove("copyIconActive");
        }
      }, 200);
      if (!el.children[0].classList.contains("noDisplay")) {
        el.children[0].classList.remove("copyIcon");
        el.children[0].classList.toggle("copyIconActive");
      } else if (!el.children[1].classList.contains("noDisplay")) {
        el.children[1].classList.remove("copyIconWhite");
        el.children[1].classList.toggle("copyIconActive");
      }
    }
  });
}

// this for action on phone button click
var phoneClicked = false;
var phoneText = document.querySelectorAll(".phoneText");
for (var i = 0; i < phoneDiv.length; i++) {
  phoneDiv[i].addEventListener("click", function () {
      if (localStorage.searchBar !== "true" && window.location.hash !== "#/searchPanel") {
        flagPhone = true;
        var el = this;
        el.children[3].classList.add("active");
        for (var j = 0; j < phoneText.length; j++) {
          if (!phoneText[j].classList.contains("noDisplay") && !phoneText[j].classList.contains("active")) {
            phoneText[j].classList.add("noDisplay");
            if (!phoneText[j].parentElement.children[0].classList.contains("noDisplay")) {
              phoneText[j].parentElement.children[0].classList.add("phoneIcon");
              phoneText[j].parentElement.children[0].classList.remove("phoneIconActive");
            } else if (!phoneText[j].parentElement.children[1].classList.contains("noDisplay")) {
              phoneText[j].parentElement.children[1].classList.add("phoneIconWhite");
              phoneText[j].parentElement.children[1].classList.remove("phoneIconActive");
            }
          } else {
            phoneText[j].classList.remove("active");
          }
        }
        if (!el.children[3].classList.contains("noDisplay")) {
          el.children[3].classList.add("noDisplay");
          el.children[2].classList.add("noDisplay");
          phoneClicked = false;
          if (!el.children[0].classList.contains("noDisplay")) {
            el.children[0].classList.add("phoneIcon");
            el.children[0].classList.remove("phoneIconActive");
          } else if (!el.children[1].classList.contains("noDisplay")) {
            el.children[1].classList.add("phoneIconWhite");
            el.children[1].classList.remove("phoneIconActive");
          }
        } else {
          el.children[3].classList.remove("noDisplay");
          el.children[2].classList.add("noDisplay");
          phoneClicked = true;
          if (!el.children[0].classList.contains("noDisplay")) {
            el.children[0].classList.remove("phoneIcon");
            el.children[0].classList.add("phoneIconActive");
          } else if (!el.children[1].classList.contains("noDisplay")) {
            el.children[1].classList.remove("phoneIconWhite");
            el.children[1].classList.add("phoneIconActive");
          }
        }
      }
    }, false);
...
// this for closing the phone tooltip on outside click
function closeOnOutsideClick() {
  if (localStorage.searchBar !== "true" && window.location.hash !== "#/searchPanel") {
    if (flagPhone) {
      for (var j = 0; j < phoneDiv.length; j++) {
        phoneDiv[j].children[3].classList.add("noDisplay");
        if (phoneDiv[j].children[0].classList.contains("phoneIconActive")) {
          phoneDiv[j].children[0].classList.add("phoneIcon");
          phoneDiv[j].children[0].classList.remove("phoneIconActive");
        } else if (phoneDiv[j].children[1].classList.contains("phoneIconActive")) {
          phoneDiv[j].children[1].classList.add("phoneIconWhite");
          phoneDiv[j].children[1].classList.remove("phoneIconActive");
        }
      }
    } else {
      flagPhone = false;
  ...
  if (flagCopyVertical) {
    for (var j = 0; j < hiddenTxt.length; j++) {
      hiddenTxt[j].style.display = "none";
      if (hiddenTxt[j].classList.contains("txtareaSafari")) {
        hiddenTxt[j].readOnly = false;
        hiddenTxt[j].classList.add("hiddenTxt");
        hiddenTxt[j].classList.remove("txtareaSafari");
      }
      if (copyDiv[j].children[0].classList.contains("copyIconActive")) {
        copyDiv[j].children[0].classList.remove("copyIconActive");
        copyDiv[j].children[0].classList.add("copyIcon");
      } else if (copyDiv[j].children[1].classList.contains("copyIconActive")) {
        copyDiv[j].children[1].classList.remove("copyIconActive");
        copyDiv[j].children[1].classList.add("copyIconWhite");
      }
    }
    flagCopyVertical = false;
  } else {
    flagCopyVertical = false;
  }
}
...
var xhttp = new XMLHttpRequest();
var card = "";
var cardsData = document.getElementsByClassName("module");
for (i = 0; i < cardsData.length; i++) {
    if (cardsData[i].getAttribute("company")) {
        card += cardsData[i].getAttribute("company") + ",";
    }
}
var url =
    "/bin/investorStockDataServlet?filterCompanyCodes=" +
...
xhttp.onload = function () {
    if (xhttp.status === 200) {
        var data = xhttp.response;
        var res = JSON.parse(data);
        var revenueCards = document.getElementsByClassName("revenueCards")[0];
        if (revenueCards) {
            for (i = 0; i < res.investorStockData.length; i++) {
                if (!res.investorStockData[i].NSEPrice) {
                    document.getElementsByClassName("nse")[i].style.display = "none";
                } else {
                    if (document.getElementsByClassName("nse")[i] != undefined) {
                        document.getElementsByClassName("nse")[i].style.display = "block";
                    }
                }
                if (!res.investorStockData[i].BSEPrice) {
                    document.getElementsByClassName("bse")[i].style.display = "none";
                } else {
                    if (document.getElementsByClassName("bse")[i] != undefined) {
                        document.getElementsByClassName("bse")[i].style.display = "block";
                    }
                }
                var NSEPerChange =
                    Math.round(res.investorStockData[i].NSEPerChange * 100) / 100;
                var BSEPerChange =
                    Math.round(res.investorStockData[i].BSEPerChange * 100) / 100;
                if(document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .bse span")[0]){
                    document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .bse span")[0].innerHTML = res.investorStockData[i].BSEPrice;
                }
                if(document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .nse span")[0]){
                    document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .nse span")[0].innerHTML = res.investorStockData[i].NSEPrice;
                }
                
                if(document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .nse span")[1]){
                    document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .nse span")[1].innerHTML = NSEPerChange + "%";
                }
                
                if(document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .bse span")[1]){
                    document.querySelectorAll(".C" + res.investorStockData[i].co_code + " .bse span")[1].innerHTML = BSEPerChange + "%";
                }
               
                if (BSEPerChange < 0) {
                    if(document.querySelector(".C" + res.investorStockData[i].co_code + " .bse")){
                        document.querySelector(".C" + res.investorStockData[i].co_code + " .bse").classList.add("neg");
                    }
                } else if (BSEPerChange > 0) {
                    if(document.querySelector(".C" + res.investorStockData[i].co_code + " .bse")){
                        document.querySelector(".C" + res.investorStockData[i].co_code + " .bse").classList.add("pos");
                    }
                }
                if (NSEPerChange < 0) {
                    if(document.querySelector(".C" + res.investorStockData[i].co_code + " .nse")){
                        document.querySelector(".C" + res.investorStockData[i].co_code + " .nse").classList.add("neg");
                    }
                } else if (NSEPerChange > 0) {
                    if(document.querySelector(".C" + res.investorStockData[i].co_code + " .nse")){
                        document.querySelector(".C" + res.investorStockData[i].co_code + " .nse").classList.add("pos");
                    }
                }
            }
        }
