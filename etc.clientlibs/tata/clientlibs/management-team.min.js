...
(function () {
    var addElemLength = 0;
    var toggleFlag1 = false;
    var toggleFlag2 = false;
    document.addEventListener("DOMContentLoaded", function () {
        var elemL = document.querySelectorAll(".bodSec .bodDiv");
        var totalCount = 0;
        for (var i = 0; i < elemL.length; i++) {
            if (window.getComputedStyle(elemL[i], null).getPropertyValue("display") == "block") {
                totalCount++
            } else
                break;
        }
        addElemLength = totalCount / 2;
        var elemCur = document.getElementsByClassName("bodDownArrow1")[0];
        var elemCur1 = document.getElementsByClassName("viewMore1")[0];
        var elemCur2 = document.getElementsByClassName("bodDownArrow2")[0];
        var elemCur3 = document.getElementsByClassName("viewMore2")[0];
        if (!(elemCur == undefined)) {
            elemCur.addEventListener("click", function (event) {
                togglebtn1(event, toggleFlag1);
            });
        }
        if (!(elemCur1 == undefined)) {
            elemCur1.addEventListener("click", function (event) {
                togglebtn1(event, toggleFlag1);
            });
        }
        if (!(elemCur2 == undefined)) {
            elemCur2.addEventListener("click", function (event) {
                togglebtn2(event, toggleFlag2);
            });
        }
        if (!(elemCur3 == undefined)) {
            elemCur3.addEventListener("click", function (event) {
                togglebtn2(event, toggleFlag2);
            });
        }
        var totalCount = 0;
    });
// this function is called on 1st load more button
    function togglebtn1(event, flags) {
        var elemL = event.currentTarget.closest("section").getElementsByClassName("bodDiv");
        if (!flags) {
            addBodElems(event);
            toggleFlag1 = true;
            if (window.innerWidth < 768) {
                elemL[2].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("viewMore1")[0].innerHTML = "View Less";
            } else if (window.innerWidth < 991 && window.innerWidth > 767) {
                elemL[4].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow1")[0].style.transform = "rotate(180deg)";
            } else {
                elemL[6].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow1")[0].style.transform = "rotate(180deg)";
            }
        } else {
            removeBodElems(event);
            toggleFlag1 = false;
            if (window.innerWidth < 768) {
                elemL[1].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("viewMore1")[0].innerHTML = "View More";
            } else if (window.innerWidth < 991 && window.innerWidth > 767) {
                elemL[3].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow1")[0].style.transform = "rotate(0deg)";
            } else {
                elemL[5].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow1")[0].style.transform = "rotate(0deg)";
            }
        }
    }
// this function is called on 2nd load more button
    function togglebtn2(event, flags) {
        var elemL = event.currentTarget.closest("section").getElementsByClassName("bodDiv");
        if (!flags) {
            addBodElems(event);
            toggleFlag2 = true;
            if (window.innerWidth < 768) {
                elemL[2].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("viewMore2")[0].innerHTML = "View Less";
            } else if (window.innerWidth < 991 && window.innerWidth > 767) {
                elemL[4].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow2")[0].style.transform = "rotate(180deg)";
            } else {
                elemL[6].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow2")[0].style.transform = "rotate(180deg)";
            }
            ...
            if (window.innerWidth < 768) {
                elemL[1].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("viewMore2")[0].innerHTML = "View More";
            } else if (window.innerWidth < 991 && window.innerWidth > 767) {
                elemL[3].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow2")[0].style.transform = "rotate(0deg)";
            } else {
                elemL[5].scrollIntoView();
                event.currentTarget.closest("section").getElementsByClassName("bodDownArrow2")[0].style.transform = "rotate(0deg)";
            }
...
// this function is called to add elements on toggle button
    function addBodElems(event) {
        var elemL = event.currentTarget.closest("section").getElementsByClassName("bodDiv");
        var totalCount = 0
        for (var i = 0; i < elemL.length; i++) {
            if (window.getComputedStyle(elemL[i], null).getPropertyValue("display") == "block") {
                ...
                if (addElemLength == 2) {
                    elemL[i].classList.remove("hidden-sm");
                } else if (addElemLength == 3) {
                    elemL[i].classList.remove("hidden-md");
                    elemL[i].classList.remove("hidden-lg");
                } else {
                    elemL[i].classList.remove("hidden-xs");
                }
            }
        }
        viewBuC = true;
    }
// this function is called to remove elements on toggle button
    function removeBodElems(event) {
        var elemL = event.currentTarget.closest("section").getElementsByClassName("bodDiv");
        if (window.innerWidth < 768) {
            for (var i = 2; i < elemL.length; i++) {
                if (addElemLength == 2) {
                    elemL[i].classList.add("hidden-sm");
                } else if (addElemLength == 3) {
                    elemL[i].classList.add("hidden-md");
                    elemL[i].classList.add("hidden-lg");
                } else {
                    elemL[i].classList.add("hidden-xs");
                }
            }
        } else if (window.innerWidth < 991 && window.innerWidth > 767) {
            for (var i = 4; i < elemL.length; i++) {
                if (addElemLength == 2) {
                    elemL[i].classList.add("hidden-sm");
                } else if (addElemLength == 3) {
                    elemL[i].classList.add("hidden-md");
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var managmentPage = document.getElementsByClassName("arrowSection");
        managmentPage[0].id = "managementTeamPage";
    });

})();
var teamButton = document.getElementsByClassName("managementTeamButton");
var teamAnchor = document.getElementsByClassName("managementTeamAnchor"); 


for(let i=0;i<teamButton.length;i++){
