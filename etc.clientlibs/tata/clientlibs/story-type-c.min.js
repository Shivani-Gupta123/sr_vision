...
var loadMoreBtn1 = document.getElementsByClassName("buttonMore");
if (loadMoreBtn1.length != 0) {
loadMoreBtn1[0].addEventListener("click", function () {
    var el = loadMoreBtn1[0].parentElement.parentElement.children[1].children[1];
    var e2 = loadMoreBtn1[0].parentElement.parentElement.parentElement;
    var storyAudiobar1 = loadMoreBtn1[0].parentElement.parentElement.children[1].children[0];
    var storyAudiobare3 = loadMoreBtn1[0].parentElement.parentElement.children[1].children[2];
    e2.scrollIntoView;
    //changed code for audio bar when present in page for view more functionality 
        if(storyAudiobar1.classList.contains("storyAudiobar")){
            if(loadMoreBtn1[0].parentElement.children[0].children[0].innerHTML == "View Less"){
                storyAudiobare3.style.display = "none";
                loadMoreBtn1[0].parentElement.children[0].children[0].innerHTML = "View More";
                e2.scrollIntoView();
            }else{
                storyAudiobare3.style.display = "block";
                loadMoreBtn1[0].parentElement.children[0].children[0].innerHTML = "View Less";
            }
        }else{
            if(loadMoreBtn1[0].parentElement.children[0].children[0].innerHTML == "View Less" && !storyAudiobar1.classList.contains("storyAudiobar")){
...
var tagItemsPress = document.querySelectorAll(".tagItems");
for (var i = 0; i < tagItemsPress.length; i++) {    
    tagItemsPress[i].addEventListener("click", function (event) {
...
if (document.getElementById("divVideo")) {
    jwplayer(document.getElementById("divVideo")).on('fullscreen', function (event) {
        if (event.currentTarget == ("undefined" && event.currentTarget)) {
            setTimeout(function () {
                document.getElementsByClassName("overlayDiv")[0].classList.toggle("fullScreenVideo");
            }, 100);
        }
    });
}
...
//event subscription
var newsletter = document.getElementsByClassName("newsletterButton")[0];
var flag = false;
var inputValidation = document.getElementsByClassName('newsletterInput')[0];
var thaksMessage = document.querySelector(".newsLetter .successBlock");
var emailAddress = document.getElementsByClassName("emailAddress")[0];
var urlhttp = "/bin/eventSubscribeServlet";
let emailWarning = document.getElementsByClassName("emailWarning")[0];
var checkboxchecked = document.getElementsByClassName('checkboxchecked')[0];
var checkboxContainer = document.getElementsByClassName("checkboxcontainer")[0];
var flag = false;
if(newsletter){
newsletter.addEventListener('click', async function(e) {
    e.preventDefault();
    newsletter.disabled=true;
    if (emailValidate() && flag == true) {
        emailWarning.style.opacity = "0";
        let payload = new FormData();
        let emailValue = document.getElementsByClassName("newsletterInput")[0].value;
        let checkBoxValue = document.getElementsByClassName("checkboxchecked")[0].value;
        payload.append("email", emailValue);
        payload.append("checkBoxValue", checkBoxValue);
        let result = await fetch(urlhttp, {
            method: "POST",
            credentials: "include",
            body: payload,
        })
        ...
        if (result.status == "Success") {
            ...
            thaksMessage.style.display = "block";
            newsletter.style.display = "none";
            emailAddress.innerHTML = emailValue;
            document.getElementsByClassName("newsletterInput")[0].value = "";
            newsletter.disabled=false;
        }
        else {
            inputValidation.style.display = "block";
            thaksMessage.style.display = "none";
            newsletter.style.display = "inline-block";
            emailWarning.innerHTML = "Please use the email ID on which you were invited"
        ...
        if (emailValidate() == false) {
            emailWarning.innerHTML = "Please enter a valid email id"
            emailWarning.style.opacity = "1";
        }
        else if (!checkboxchecked.checked && emailValidate() == false) {
            emailWarning.innerHTML = "Please enter a valid email id"
            emailWarning.style.opacity = "1";

        }
        else {
            emailWarning.innerHTML = "Please accept terms and conditions before proceeding"
            emailWarning.style.opacity = "1";
...
newsletter.disabled=false;
    ...
    //no newsletter component found 
}


function emailValidate() {
    let check = document.getElementsByClassName("newsletterInput")[0].value;
    let pattern = new RegExp(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{1,4}))$/);
...
if(checkboxchecked){
  checkboxchecked.addEventListener('change', function (e) {
    ...
    if (e.target.checked) {
        if (emailValidate() == true) {
            newsletter.style.cursor = "allowed";
            emailWarning.style.opacity = "0";
        }
        else {
            emailWarning.innerHTML = "Please enter a valid email id"
...
checkboxchecked.style.width="3rem";
}
else {
   // Anything else
}
...
if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
    checkboxchecked.style.marginTop = "-16px"
}
else {
    var x = (window.matchMedia("(min-width: 992px)").matches)

    if (x) {

        checkboxchecked.style.marginTop = "1rem"
    }
}
}
